...
void fdcan1_rx_callback(void)
{
	...
	{
 		 case 0x11: 
			//dm_motor_fbdata(&motor4340[Motor1], rx_data); receive_motor_data(&motor4340[Motor1], rx_data); 
			for(int i=0; i<8; i++)
			{
				motor[Motor1].ori_date[i] = rx_data[i];
			}
			init_motor_data[0] = 0;
		break;
		case 0x12: 
			...
			for(int i=0; i<8; i++)
			{
				motor[Motor2].ori_date[i] = rx_data[i];
			}
			init_motor_data[1] = 0;
		break;
		case 0x13: 
			...
			for(int i=0; i<8; i++)
			{
				motor[Motor3].ori_date[i] = rx_data[i];
			}
			init_motor_data[2] = 0;
		break;
		...
		case 0x14: 
			...
			for(int i=0; i<8; i++)
			{
				motor[Motor4].ori_date[i] = rx_data[i];
			}
			init_motor_data[3] = 0;
		break;
		case 0x15: 
			...
			for(int i=0; i<8; i++)
			{
				motor[Motor5].ori_date[i] = rx_data[i];
			}
			init_motor_data[4] = 0;
		break;
		case 0x16: 
			...
			for(int i=0; i<8; i++)
			{
				motor[Motor6].ori_date[i] = rx_data[i];
			}
			init_motor_data[5] = 0;
		break;
